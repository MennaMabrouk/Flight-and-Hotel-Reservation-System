...
public class cash extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        place.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "151 Mohamed Farid Street - Cairo", "9 Rue Auber, 75009 Paris – France", "Crystal Plaza, Buhaira Corniche, Sharjah - UAE", "Marienstr. 15, D-60329 Frankfurt am Main", "Khalifa Street - Dina Building - PO Box 533 - Abu Dhabi - UAE" }));
        ...
        time.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "6", "8", "9", "10" }));
        ...
        day.setForeground(new java.awt.Color(255, 153, 51));
        day.setText("Day");
        ...
        night.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        night.setForeground(new java.awt.Color(255, 153, 51));
        night.setText("Night");

        next_btn.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        next_btn.setText("Next");
        next_btn.setToolTipText("");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(night, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(next_btn, javax.swing.GroupLayout.PREFERRED_SIZE, 116, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(67, 67, 67))))
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel1)
                    .addComponent(place, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void next_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_next_btnActionPerformed
        // TODO add your handling code here
       String str = null;
if (day.isSelected()){str="YOur date is set  place : "+place.getItemAt(place.getSelectedIndex())+"\n";
str= str+"date  :"+time.getItemAt(place.getSelectedIndex())+" am";
JOptionPane.showMessageDialog(this,str , "Confirm",JOptionPane.QUESTION_MESSAGE );}
else{str="YOur date is set  place : "+place.getItemAt(place.getSelectedIndex())+"\n";
str= str+"date  :"+time.getItemAt(place.getSelectedIndex())+" pm";
JOptionPane.showMessageDialog(this,str , "Confirm",JOptionPane.QUESTION_MESSAGE );}
